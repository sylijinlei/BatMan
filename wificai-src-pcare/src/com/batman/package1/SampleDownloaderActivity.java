...
public class SampleDownloaderActivity extends Activity implements IDownloaderClient {
    ...
    private static final XAPKFile[] xAPKS = {
            new XAPKFile(true, 1, 92943058L)  //modified to adaptive to your application --ryne
            // main file only
    };
    ...
    boolean expansionFilesDelivered() {
    	Log.e("expansionFilesDelivered", "this.getPackageName = "+this.getPackageName());
    	
        for (XAPKFile xf : xAPKS) {
            String fileName = Helpers.getExpansionAPKFileName(this, xf.mIsMain, xf.mFileVersion);
            String zipfile = Environment.getExternalStorageDirectory() + File.separator + "Android"
                    + File.separator + "obb" + File.separator + this.getPackageName() + File.separator + fileName;
            File expFile = new File(zipfile);
            Log.e("expansionFilesDelivered","zipfile length -->"+expFile.length()+"  zipfile :"+zipfile);
            Log.e("expansionFilesDelivered", "expasion file name :"+fileName+"  doesFileExist -->"+Helpers.doesFileExist(this, fileName, xf.mFileSize, false));
    ...
    void validateXAPKZipFiles() {
    	Log.e("validateXAPKZipFiles", "validateXAPKZipFiles");
        AsyncTask<Object, DownloadProgressInfo, Boolean> validationTask = new AsyncTask<Object, DownloadProgressInfo, Boolean>() {

            @Override
            protected void onPreExecute() {
                mDashboard1.setVisibility(View.VISIBLE);
            ...
            protected Boolean doInBackground(Object... params) {
            	Log.e("validateXAPKZipFiles", "do in Background");
                for (XAPKFile xf : xAPKS) {
...
//            	Log.e("onPostExecute", "onPostExecute");
                if (result) {
                	Log.e("onPostExecute", "onPostExecute result is true");
                    mDashboard1.setVisibility(View.VISIBLE);
                    mCellMessage.setVisibility(View.GONE);
    ...
    private void initializeDownloadUI() {
        ...
        mDashboard1 = findViewById(R.id.downloaderDashboard1);
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Log.e("SampleDownloaderActivity", "in oncreate ...");
        ...
        if (!expansionFilesDelivered()) {
        	Log.e("onCreate", "需要下载扩展文件");
        	final AlertDialog.Builder connectDialog = new AlertDialog.Builder(new ContextThemeWrapper(this, R.layout.share_dialog));
    		connectDialog.setTitle("Error");
    		
    		connectDialog.setMessage("The expansion file of the application has been removed, you should reinstall it!");
...
//                	Log.e("onCreate", "The DownloaderService has started downloading the files, show progress");
...
//            }
        ...
        Log.e("onCreate", "扩展文件已经存在，不需要下载扩展文件");
        initializeDownloadUI();
//        validateXAPKZipFiles();
    ...
    protected void onResume() {
        if (null != mDownloaderClientStub) {
        	Log.e("mDownloaderClientStub", "将ClientStub连接到上线文");
    ...
    public void onDownloadStateChanged(int newState) {
        setState(newState);
        Log.e("onDownloadStateChanged", "setState --> "+newState);
