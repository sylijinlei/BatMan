...
public class AppHorizontalScroViewRight extends HorizontalScrollView{

	public static AppHorizontalScroViewRight instance;
	...
	public AppHorizontalScroViewRight(Context context) {
		super(context);
		instance = this;
	}

	public AppHorizontalScroViewRight(Context context, AttributeSet attrs) {
		super(context, attrs);
		instance = this;
	}
	...
	public Handler handler = new Handler(){
		...
		public void handleMessage(Message msg) {
			...
			case SCROLL_END:
				...
				checkRange(pre_x);
				AppConnect.getInstance().callBack(CustomerInterface.MESSGE_SCROLL_RIGHT);
				break;
	...
	public boolean onTouchEvent(MotionEvent event) {
		try {
			...
			case MotionEvent.ACTION_MOVE:
					if(AppInforToSystem.bottom_btn_scroll_flagright !=3){
					AppInforToSystem.bottom_btn_scroll_flagright  = 3;
					AppConnect.getInstance().callBack(CustomerInterface.MESSGE_SCROLL_RIGHT);
				}
				break;
	...
	public void checkRange(int value){
		try {
			if (value <= AppInforToSystem.bottom_btn_scroll_range / 2) {
				...
				AppInforToSystem.bottom_btn_scroll_flagright = 0;
			}
			this.computeScroll();
		} catch (Exception e) {
			AppInforToSystem.bottom_btn_scroll_flag = 0;
